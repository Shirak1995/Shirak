...
// Нарушен принцип KISS: название класса не несет информации о том, что он из себя представляет, для чего он нужен и тд
public class D {
    ...
    // KISS: название метода ca не несет информации о том, что делает метод. Например, можно было бы назвать createArticle
    ...
    // KISS: название метода gai не несет информации о том, что делает метод. Например, можно было бы назвать getArticleById
    ...
    // KISS: название метода ga не несет информации о том, что делает метод. Например, можно было бы назвать getArticleByTitle
    ...
    // KISS: название метода ga не несет информации о том, что делает метод. Например, можно было бы назвать getArticles
    ...
    // KISS: название метода ua не несет информации о том, что делает метод. Например, можно было бы назвать updateArticle
    ...
    // KISS: название метода da не несет информации о том, что делает метод. Например, можно было бы назвать deleteArticle
    ...
    // KISS: название метода cu не несет информации о том, что делает метод. Например, можно было бы назвать createUser
    ...
    // KISS: название метода gubi не несет информации о том, что делает метод. Например, можно было бы назвать getUserById
    ...
    // KISS: название метода gubu не несет информации о том, что делает метод. Например, можно было бы назвать getuserByName
    ...
    // KISS: название метода gau не несет информации о том, что делает метод. Например, можно было бы назвать getAllUsers
    ...
    // KISS: название метода uu не несет информации о том, что делает метод. Например, можно было бы назвать updateUser
    ...
    // KISS: название метода du не несет информации о том, что делает метод. Например, можно было бы назвать deleteUserById
    ...
    // KISS: название метода cur не несет информации о том, что делает метод. Например, можно было бы назвать updateUsersRole
    ...
    // KISS: название метода cp не несет информации о том, что делает метод. Например, можно было бы назвать getUserPassword
