...
// Класс Main должен использоваться только для запуска приложения и не должен содержать в себе дополнительную логику.
public class Main {
    ...
    static void login(D database) {
        ...
        // YAGNI: в данном коде эта переменная нигде не используется
    ...
    // YAGNI: в данном коде этот метод нигде не используется
    static void logout() {
        isLoggedIn = false;
        loggedInUserId = 0;
    ...
    // KISS: метод лучше было бы назвать deleteUserById, чтобы он был более информативным
    ...
    static void addUser(D database) {
        ...
        // Нарушен принцип KISS: названия переменных и юзера не несут информации о том, что они обозначают
    ...
    static void deleteUser(D database) {
        ...
        // Нарушен принцип KISS: название переменной не несет информации о том, что оно обозначает
    ...
    static void addArticle(D database) {
        ...
        // Нарушен принцип KISS: названия переменных t и c не несут информации о том, что они обозначают
    ...
    static void listAllArticles(D database) {
        // Нарушен принцип KISS: название переменной a не несет информации о том, что оно обозначает
